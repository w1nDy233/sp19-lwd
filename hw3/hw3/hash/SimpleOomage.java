...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if(this.red== tmp.red&&this.blue==tmp.blue&&this.green==tmp.green){
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int hash=0;
            hash=31*hash+((Integer) red).hashCode();
            hash=31*hash+((Integer) green).hashCode();
            hash=31*hash+((Integer) blue).hashCode();
            return hash;
        }
    }
